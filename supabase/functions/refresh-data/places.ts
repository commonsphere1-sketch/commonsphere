 ...
 *
 * GENERATED by build-news-places.cjs on 2026-09-25 from src/data/countriesData.ts
...
export const COUNTRY_NAMES: [string, string][] = [
  ...
  ["KH", "Cambodia"], ["KI", "Kiribati"], ["KM", "Comoros"], ["KN", "Saint Kitts & Nevis"],
  ...
  ["SZ", "Eswatini"], ["TC", "Turks and Caicos Islands"], ["TD", "Chad"], ["TF", "French Southern and Antarctic Lands"],
  ...
  ["VC", "Saint Vincent & the Grenadines"], ["VE", "Venezuela"], ["VG", "British Virgin Islands"], ["VI", "US Virgin Islands"],
