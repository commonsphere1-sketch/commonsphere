...
import { Globe, Newspaper, ArrowLeft } from "@phosphor-icons/react";
    ...
    <div className="min-h-screen bg-[#06101f] text-white font-sans flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center pt-14 px-6">
        <div className="max-w-2xl w-full text-center py-20">
          <Newspaper size={48} weight="fill" className="text-violet-400 mx-auto mb-6" />
          <h1 className="text-4xl font-bold mb-4" style={{ fontFamily: "Georgia, serif" }}>Research Notes</h1>
          <p className="text-slate-400 text-sm leading-relaxed mb-8">
            Your personal space for annotating data, saving research threads, and building reports. Combine bookmarks, metrics, and your own written observations into shareable research notes.
          </p>
          <button
